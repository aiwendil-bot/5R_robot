...
class FiveBars(Robot):
    ...
    def _draw_workspace(self):
        ...
        c3 = pyplot.Circle((-12,-6),1.5,color='red',fill=True)
        c4 = pyplot.Circle((-12,0),1.1,color='red',fill=True)
        c5 = pyplot.Circle((-12,6),1.8,color='red',fill=True)
        c6 = pyplot.Circle((-6,-18),2.8,color='red',fill=True)
        c7 = pyplot.Circle((-6,-12),2.9,color='red',fill=True)
        c8 = pyplot.Circle((-6,-6),0.6,color='red',fill=True)
        c9 = pyplot.Circle((-6,0),1.6,color='red',fill=True)
        c10 = pyplot.Circle((-6,6),0.4,color='red',fill=True)
        c11 = pyplot.Circle((-6,12),1.9,color='red',fill=True)
        c12 = pyplot.Circle((-6,18),0.4,color='red',fill=True)
        c13 = pyplot.Circle((0,-24),2.4,color='red',fill=True)
        c14 = pyplot.Circle((0,-12),1.9,color='red',fill=True)
        c15 = pyplot.Circle((0,-6),0.5,color='red',fill=True)
        c16 = pyplot.Circle((0,0),1.8,color='red',fill=True)
        c17 = pyplot.Circle((0,6),2.9,color='red',fill=True)
        c18 = pyplot.Circle((0,12),1.7,color='red',fill=True)
        c19 = pyplot.Circle((0,24),0.5,color='red',fill=True)
        c20 = pyplot.Circle((6,-18),1.9,color='red',fill=True)
        c21 = pyplot.Circle((6,-12),2.8,color='red',fill=True)
        c22 = pyplot.Circle((6,-6),0.4,color='red',fill=True)
        c23 = pyplot.Circle((6,0),1.9,color='red',fill=True)
        c24 = pyplot.Circle((6,6),0.3,color='red',fill=True)
        c25 = pyplot.Circle((6,12),2.3,color='red',fill=True)
        c26 = pyplot.Circle((6,18),1.2,color='red',fill=True)
        c27 = pyplot.Circle((12,-6),2.8,color='red',fill=True)
        c28 = pyplot.Circle((12,0),1.3,color='red',fill=True)
        c29 = pyplot.Circle((12,6),2.1,color='red',fill=True)
        self.ax.add_artist(C1)
        self.ax.add_artist(c1)
        self.ax.add_artist(C2)
        self.ax.add_artist(c2)
        self.ax.add_artist(c3)
        self.ax.add_artist(c4)
        self.ax.add_artist(c5)
        self.ax.add_artist(c6)
        self.ax.add_artist(c7)
        self.ax.add_artist(c8)
        self.ax.add_artist(c9)
        self.ax.add_artist(c10)
        self.ax.add_artist(c11)
        self.ax.add_artist(c12)
        self.ax.add_artist(c13)
        self.ax.add_artist(c14)
        self.ax.add_artist(c15)
        self.ax.add_artist(c16)
        self.ax.add_artist(c17)
        self.ax.add_artist(c18)
        self.ax.add_artist(c19)
        self.ax.add_artist(c20)
        self.ax.add_artist(c21)
        self.ax.add_artist(c22)
        self.ax.add_artist(c23)
        self.ax.add_artist(c24)
        self.ax.add_artist(c25)
        self.ax.add_artist(c26)
        self.ax.add_artist(c27)
        self.ax.add_artist(c28)
        self.ax.add_artist(c29)
